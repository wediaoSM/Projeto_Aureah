      ...
      <div className="max-w-6xl mx-auto px-4 lg:px-8 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="text-white font-semibold">Aureah</span>
          </div>

          {/* Links essenciais */}
          <div className="flex items-center space-x-6 text-sm">
            <a href="mailto:contato@intotheshadows.com.br" className="text-gray-400 hover:text-purple-300 transition-colors">
              Contato
            </a>
            <a href="/termos" className="text-gray-400 hover:text-purple-300 transition-colors">
              Termos
            </a>
            <a href="/privacidade" className="text-gray-400 hover:text-purple-300 transition-colors">
              Privacidade
            </a>
          </div>
        ...
        <div className="border-t border-gray-800 mt-6 pt-6 text-center">
          <p className="text-gray-500 text-sm">
            © 2025 Aureah. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
